...
<body>
    ...
    <div class = "container mt-4">
        ...
        <form action="proses.php?aksi=ubah" method="post">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input type="radio" class="form-check-input" name="jenis_kelamin" value="L" id="laki" <?php 
                    if($row['jenis_kelamin']==='L') echo 'checked';?> required>
                        <label class="form-check-label" for="laki"> Laki-laki</label>
                </div>
                <div class="form-check">
                    <input type="radio" class="form-check-input" name="jenis_kelamin" value="P" id="perempuan" <?php 
        ...
        <a class="btn btn-secondary mt-2" href="indeksB.php">Kembali</a>
    </div>
